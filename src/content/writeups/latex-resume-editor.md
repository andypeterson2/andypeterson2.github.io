...
A web editor for résumés, CVs, and cover letters, backed by a normalized **SQLite database as the single source of truth** — content lives as structured records, not a blob of markup.

      ...
      entries: [
        {
          ...
          items: [
            { id: 60, content: 'Python', tags: [] },
            { id: 61, content: 'TypeScript', tags: [] },
            { id: 62, content: 'C/C++', tags: [] },
            { id: 63, content: 'Java', tags: [] },
            { id: 64, content: 'SQL', tags: [] },
          ],
          tags: [],
        },
        {
          id: 7,
          fields: { category: 'Quantum' },
          items: [
            { id: 70, content: 'Qiskit', tags: [] },
            { id: 71, content: 'BB84', tags: [] },
            { id: 72, content: 'Grover', tags: [] },
          ],
          tags: [],
        },
        {
          ...
          items: [
            { id: 80, content: 'Docker', tags: [] },
            { id: 81, content: 'Kubernetes', tags: [] },
            { id: 82, content: 'Terraform', tags: [] },
            { id: 83, content: 'AWS', tags: [] },
            { id: 84, content: 'Azure', tags: [] },
            { id: 85, content: 'Linux', tags: [] },
            { id: 86, content: 'CI/CD', tags: [] },
          ],
          tags: [],
        },
        {
          id: 9,
          fields: { category: 'AI / ML' },
          items: [
            { id: 90, content: 'PyTorch', tags: [] },
            { id: 91, content: 'Scikit-Learn', tags: [] },
          ],
          tags: [],
        },
        {
          ...
          items: [
            { id: 100, content: 'Cryptography', tags: [] },
            { id: 101, content: 'CTF', tags: [] },
          ],
          tags: [],
        },
      ],
